"""beat_segmenter agent:单批剧情段增量抽取 + 合并。
...
公开 API::
    ...
    from agents.beat_segmenter import (
        run_for_batch, merge_delta, apply_character_renames, CONTEXT_WINDOW,
...
from agents.beat_segmenter.logic import (
    CONTEXT_WINDOW,
